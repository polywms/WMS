...
function renderOffBsList() {
    ...
    if (!container) return; // Pengaman agar tidak error
    
    // HANYA AMBIL DATA YANG BOX-NYA TIDAK DI-HIDDEN (Sesuai Filter Modal)
    ...
    // Tampilkan jumlah item berdasarkan yang Tampil di layar saja
    ...
    visibleSession.forEach((item, index) => {
